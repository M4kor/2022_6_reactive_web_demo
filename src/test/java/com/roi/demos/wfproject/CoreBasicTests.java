...
import com.roi.demos.wfproject.domain.StockUnitException;
...
public class CoreBasicTests {
    ...
    public void basicSubscriptionExampleWithPublisherOnError(){
        Flux<String> strSeq = Flux.just(1,3,5,8,0)
                .map( e -> {
                   if (e==8) {throw new IllegalStateException("faux prime number");}
                   if (e==10) {throw new IllegalArgumentException("faux receipt");}
                    int v = 100;
